# OpenGL Fairy World 🧚‍♀️

## Overview

This project implements a **photorealistic 3D fairy world** using modern OpenGL.
The scene contains multiple animated objects, environmental effects, and realistic lighting.
...
* material properties interacting with the lighting system
...
Several elements in the scene are animated:
...
These effects help create a more immersive environment.

---

## Scene Description

The environment represents a **fantasy fairy world** containing objects such as:
...
The scene emphasizes visual detail and atmosphere.
...
Computer Graphics Project – OpenGL Fairy World
